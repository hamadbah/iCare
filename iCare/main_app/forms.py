...
from .models import Profile, Appointment, VitalSign, DoctorNote, Prescription, Lab, Diagnosis, NurseNote, DoctorOrder, Alert, Allergy
...
class AllergyForm(forms.ModelForm):
    class Meta:
        model = Allergy
        fields = ['allergy_name', 'severity','allergy_status']